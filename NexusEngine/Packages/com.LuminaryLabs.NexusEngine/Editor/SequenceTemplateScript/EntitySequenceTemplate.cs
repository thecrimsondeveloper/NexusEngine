...
public class EntitySequenceTemplate : EntitySequence<EntitySequenceTemplateData>
{
    /// <summary>
    ...
    protected override UniTask Initialize(EntitySequenceTemplateData currentData)
    {
...
public class EntitySequenceTemplateData : EntitySequenceData
{
